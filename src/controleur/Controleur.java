...
//		spr1.setId(4);
	    ...
	    case 1:  sprCoeurs3.setId(4);
	    		 sprCoeurs2.setId(4);
	    		 sprCoeurs1.setId(3);
	    		 break;
		case 2:  sprCoeurs3.setId(4);
			     sprCoeurs2.setId(4);
				 sprCoeurs1.setId(2);
		        break;
		case 3:  sprCoeurs3.setId(4);
				 sprCoeurs2.setId(4);
				 sprCoeurs1.setId(1);
		        break;
		case 4:  sprCoeurs3.setId(4);
				 sprCoeurs2.setId(4);
		        break;
		case 5:  sprCoeurs3.setId(4);
				 sprCoeurs2.setId(3);
		        break;
		case 6:  sprCoeurs3.setId(4);
				 sprCoeurs2.setId(2);
		        break;
		case 7: sprCoeurs3.setId(4);
				sprCoeurs2.setId(1);
		        break;
		case 8:  sprCoeurs3.setId(4);
		        break;
		case 9:  sprCoeurs3.setId(3);
		        break;
		case 10: sprCoeurs3.setId(2);
		        break;
		case 11: sprCoeurs3.setId(1);
		        break;
